    ...
    <>
      ...
      // In App.js
       <Route path="/superadmin/*" element={<SuperAdminRouting />} />
        ...
        {/* Private Routes */}
        <Route path="/buy/:productId" element={<PrivateRoute><Buy /></PrivateRoute>} />
        <Route path="/bank-details" element={<PrivateRoute><Payment/></PrivateRoute>} />
        <Route path="/userDashbaord" element={<PrivateRoute><UserDashboard /></PrivateRoute>} />
        <Route path="/myproduct" element={<PrivateRoute><MyProduct /></PrivateRoute>} />
        ...
        <Route path="/products" element={<PrivateRoute><ListSidebar /></PrivateRoute>} />
        <Route path="/product-details" element={<PrivateRoute><PropertyDetails /></PrivateRoute>} />
        <Route path="/product-details/:productId" element={<PrivateRoute><PropertyDetails /></PrivateRoute>} />
